...
export function NewTopicForm({ folders }: NewTopicFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const result = await createTopicAction({ title, tags, content, userId, folderId });
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="grid gap-2">
                    ...
                    <Select onValueChange={(value) => setFolderId(value === 'none' ? null : value)} disabled={isLoading}>
